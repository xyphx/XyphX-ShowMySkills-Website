  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="w-[90%] mx-auto p-4">
        {/* Hero Section */}
        <div className="bg-[url('/profilebg.png')] bg-cover bg-center rounded-t-3xl p-6 text-white relative overflow-hidden">
        ...
        {/* Content Sections */}
        <div className="shadow-black/30 shadow-inner rounded-b-3xl px-16 py-8 mb-8 space-y-8 bg-[#FFF8F0]">
          {/* About Section */}
          <div className="bg-white shadow-sm shadow-black/30 rounded-2xl p-6">
            <p className="text-black leading-relaxed">{profileData.about}</p>
          </div>
          ...
          <div className="bg-white shadow-sm shadow-black/30 rounded-2xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {profileData.skills.map((skill, index) => (
                <span
                  key={index}
                  className="bg-teal-100 text-teal-700 px-4 py-2 rounded-full text-sm font-medium border border-teal-200"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="text-center pt-4">
            <button className="cursor-pointer bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 rounded-full font-medium transition-colors">
              Contact
            </button>
          </div>
        </div>
